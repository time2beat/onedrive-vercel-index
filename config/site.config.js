...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'ewsdrive@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/time2beat/',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/ewsos',
    },
  ],
